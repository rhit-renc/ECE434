...
static unsigned int gpioLED1 = 15;       ///< hard coding the LED gpio for this example to P9_17 (GPIO5)
static unsigned int gpioButton1 = 14;   ///< hard coding the button gpio for this example to P9_16 (GPIO48)
